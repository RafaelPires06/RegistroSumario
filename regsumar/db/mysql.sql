...
INSERT INTO `user` (idUser, idrole, name, email, password )VALUES (1, 3,'Paulo Silva	','psilva@uta.cv','4321');
INSERT INTO `user` (idUser, idrole, name, email, password )VALUES (2, 3,'Eduarda Pires','epires@uta.cv','1234');
INSERT INTO `user` (idUser, idrole, name, email, password )VALUES (3, 3,'Rafael Pires ','rpires@uta.cv','1234eu');
INSERT INTO `user` (idUser, idrole, name, email, password )VALUES (4, 3,'Roberto Medina','rmedina@uta.cv','6789');
